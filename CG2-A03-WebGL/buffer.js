...
/* 
   ...
   - shaderVarName is the name of the shader variable that 
     this attribute will be bound to 
...
VertexAttributeBuffer = function(gl, shaderVarName, dataType, 
    ...
    this.makeActive = function(program) {
        ...
        var location = gl.getAttribLocation(program.glProgram, this.shaderVarName);
        if(location < 0) {
            window.console.log("Warning: attribute " + this.shaderVarName 

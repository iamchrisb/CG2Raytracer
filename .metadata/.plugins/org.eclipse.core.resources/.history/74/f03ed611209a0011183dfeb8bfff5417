...
public class Materials {
	...
	public static Material blue = new Material(new Color(0.f,0.0f,0.5f),new Color(0.f,0.0f,.5f), new Color(0f,0f,0.3f), 100 );
	
	public static Material green = new Material(new Color(0.0f,0.5f,0.0f),new Color(0.0f,0.5f,0.0f), new Color(0,0.2f,0.0f), 100);
